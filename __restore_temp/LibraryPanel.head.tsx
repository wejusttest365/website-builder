        ...
        <div className="w-56 border-r border-border/70 bg-background/50 flex flex-col flex-shrink-0">
          <div className="px-3 py-3">
            <div className="flex flex-col items-stretch gap-2">
                ...
                {MENU_ITEMS.map(({ key, label, Icon }) => (
                  <Tooltip key={key}>
                      <TooltipTrigger asChild>
                        <button
                          onClick={() => {
                            // Always open the left panel and switch view ΓÇö do not collapse when clicking the active icon
              ...
              {/* Removed centered pill ΓÇö labels are shown under each icon consistently */}
            </div>
          </div>
                    ...
                    <div className="w-full rounded-lg border border-border/70 bg-background/90 p-1.5">
                      <div className="w-full relative">
                        ...
                        <input
                          ...
                          placeholder="Search sectionsΓÇª"
  ...
  Continue with Google
              ...
              <form onSubmit={handleAuthSubmit} className="space-y-2">
                ...
                <Button type="submit" className="w-full rounded-2xl bg-slate-950 py-2.5 text-base font-semibold text-white hover:bg-slate-900">
                  {signingIn ? (authMode === "sign-in" ? "Signing inΓÇª" : "Creating accountΓÇª") : (authMode === "sign-in" ? "Sign In" : "Create Account")}
                </Button>
              </form>
