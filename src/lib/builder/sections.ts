...
export const SECTION_LIBRARY: SectionTemplate[] = [
  ...
  <div class="max-w-3xl mx-auto px-6 py-20">
    ...
    <div class="mt-10 space-y-3">
      <details class="p-5 rounded-xl border border-gray-200 group"><summary class="font-semibold cursor-pointer flex justify-between">What is included in the free plan?<span class="group-open:rotate-180 transition">▾</span></summary><p class="mt-3 text-gray-600">Everything you need to get started, forever free.</p></details>
      <details class="p-5 rounded-xl border border-gray-200 group"><summary class="font-semibold cursor-pointer flex justify-between">Can I cancel anytime?<span class="group-open:rotate-180 transition">▾</span></summary><p class="mt-3 text-gray-600">Yes, cancel with a single click in your dashboard.</p></details>
      <details class="p-5 rounded-xl border border-gray-200 group"><summary class="font-semibold cursor-pointer flex justify-between">Do you offer refunds?<span class="group-open:rotate-180 transition">▾</span></summary><p class="mt-3 text-gray-600">30 day money back guarantee, no questions asked.</p></details>
    </div>
  </div>
</section>`,
  },
